...
import com.sy.dao.OrganizationDao;
...
public class OrganizationServiceImpl implements OrganizationService {
	...
	@Override
	public List<Organization> findAllOrgByPageManage(Organization organization,Map<String,Object> map) {
		return organizationDao.findAllOrgByPage(organization,map);
	}

	@Override
	public Long totalCount(Organization organization,Map<String, Object> map) {
		return organizationDao.totalCount(organization,map);
	}
}
