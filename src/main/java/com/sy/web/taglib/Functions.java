...
import com.sy.service.ResourceService;
import com.sy.service.RoleService;
import com.sy.spring.SpringUtils;
...
public class Functions {
	...
	public static String organizationName(Long organizationId) {
		...
		if(organizationId==0){
			organization = getOrganizationService().findOne(1L);
		}else{
	...
	public static String organizationNameToShow(Long organizationId) {
