...
public class RoleDaoImpl implements RoleDao {
	...
	public Role createRole(final Role role) {
		final String sql = "insert into sys_role(role, description, resource_ids, available,create_time) values(?,?,?,?,?)";
		...
		jdbcTemplate.update(new PreparedStatementCreator() {
			...
			public PreparedStatement createPreparedStatement(
				...
				psst.setDate(count++, new Date(role.getCreateTime().getTime()));
				return psst;
			}
		}, keyHolder);
	...
	public Role findOne(Long roleId) {
		final String sql = "select id, role, description, resource_ids as resourceIdsStr, available,create_time,update_time  from sys_role where id=?";
	...
	public List<Role> findAll() {
		final String sql = "select id, role, description, resource_ids as resourceIdsStr, available , create_time,update_time from sys_role";
