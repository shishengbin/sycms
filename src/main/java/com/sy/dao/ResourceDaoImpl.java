...
public class ResourceDaoImpl implements ResourceDao {
    ...
    public Resource findOne(Long resourceId) {
        final String sql = "select id, name, type, url, permission, parent_id, parent_ids, available,rel  from sys_resource where id=?";
    ...
    public List<Resource> findAll() {
        final String sql = "select id, name, type, url, permission, parent_id, parent_ids, available,rel  from sys_resource order by concat(parent_ids, id) asc";
