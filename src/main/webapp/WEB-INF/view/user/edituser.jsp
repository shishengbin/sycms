...
<div class="pageContent">
	<form:form id="form" action="" method="post" commandName="upduser" class="pageForm required-validate" onsubmit="return iframeCallback(this,dialogAjaxDone);">
		<form:hidden path="id"/>
		...
		<div class="pageFormContent nowrap" layoutH="56">
			<dl>
				<dt style="width:80px"><form:label path="username">用户名s：</form:label></dt>
			...
			<dl>
            	...
            	<dd style="width:200px">
            		<input type="text" id="organizationName" name="organizationName" value="${zhangfn:organizationNameToShow(upduser.organizationId)}" readonly="readonly">
	...
	<div id="menuContent" class="menuContent" style="display:none; position: absolute;left: 95px;top: 80px;">
